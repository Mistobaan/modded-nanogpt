...
COMMIT_SHA = "1b51e26d304f647c7c12201b3f1513ee5a429ec4"
...
image = (
    ...
    .add_local_file(Path(__file__).parent / "train_gpt.py", "/root/train_gpt.py")
)
...
ckpt = modal.Volume.from_name("modded-nanogpt-ckpt", create_if_missing=True)
...
def train():
    ...
    subprocess.run(
        ["torchrun", "--standalone", f"--nproc_per_node={N_H100}", "train_gpt.py"]
    )
